  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p
          className="mt-2 text-[#666675] text-[16px] 
            max-w[500px]"
        >
          Create imaginative and vosually stunning images through DALL-E AI and
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <div
            ...
            p-3 h-64 flex justify-center items-cemter"
          >
            {form.photo ? (
              <img
                src={form.photo}
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Once you have creted the image you want, you can share it with
